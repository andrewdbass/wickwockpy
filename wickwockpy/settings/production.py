...
INSTALLED_APPS = (
    ...
    'apps.video_sources',
    'apps.tags',
    'apps.podcast_sources',
    'apps.podcast_source_types'
)
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'wickwockpy'),
        'USER': os.environ.get('DB_USER', 'wickwockpy'),
        'PASSWORD': os.environ.get('DB_PASS', 'wickwockpy'),
...
# General
MANAGERS = ADMINS = (
    ('wickwockpy Admin', 'wickwockpy+admin@izeni.com'),
)

IZENI = {
    'ADMIN': {
        'SITE_TITLE': "wickwockpy backend",
    }
}
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'formatter': 'default',
            'filename': '/var/log/wickwockpy/django.log',
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'wickwockpy', 'templates'),
...
# Static/Media
MEDIA_ROOT = '/var/media/wickwockpy/media'
MEDIA_URL = '/media/'
STATIC_ROOT = '/var/media/wickwockpy/static'
STATIC_URL = '/static/'
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'wickwockpy', 'static'),
)


# URLs
ROOT_URLCONF = 'wickwockpy.urls'


# ./manage.py runserver WSGI configuration
WSGI_APPLICATION = 'wickwockpy.wsgi.application'
